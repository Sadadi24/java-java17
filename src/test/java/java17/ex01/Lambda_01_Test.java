...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
        ...
        PersonPredicate persone = (p) -> p.getAge()>=18;

        List<Person> result = filter(personList, persone);
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        PersonPredicate res= (p) -> p.getFirstname().equals("first_10");
        List<Person> result = filter(personList, res);
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate res= p ->  p.getAge() > 49 && DigestUtils.sha512Hex(p.getPassword()).equals(passwordSha512Hex);
